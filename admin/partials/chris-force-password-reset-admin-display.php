 ...
 * @subpackage fpr_Chris_Force_Password_Reset/admin/partials
 */
?>
...
<div class="wrap">
        ...
        <form method="post" name="cleanup_options" action="options.php">
            ...
            <fieldset>
                <h3>Number of Days Before Next Reset</h3>
                <legend class="screen-reader-text"><span><?php _e('Number of Days Before Reset',$this->plugin_name); ?></span></legend>
                <input type="number" min="1" class="regular-text" id="<?php echo $this->plugin_name; ?>-number_of_days" name="<?php echo $this->plugin_name; ?>[number_of_days]" value="<?php if(!empty($number_of_days)) echo $number_of_days;  if(empty($number_of_days)) echo 30; ?>" />
            </fieldset>
